...
$sql="select distinct subject_name from video order by subject_name asc";
...
<input type="submit" name="sub-search" value="Search" />
</form>
</div>
<?php
...
?>	
          ...
          <div class="panel-card">
            <?php echo "<a href='watch.php?id=$id'>"; ?>
...
<td><?php  echo "<a href='../watch.php?id=$id'>".$name."</a>"; ?></td>
</tr> -->
<?php 
...
?>
      ...
      <a href="staff_dashboard-videos.php"> <div class="back-btn"><i class="fa fa-chevron-left" aria-hidden="true"></i></i></div></a>
    <!-- </div> -->
  </div>    
